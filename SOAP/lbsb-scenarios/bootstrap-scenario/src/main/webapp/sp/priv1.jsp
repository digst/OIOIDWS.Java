...
<%@page import="dk.itst.oiosaml.sp.service.util.Constants"%>
    ...
    <a href="query.jsp">Perform attribute query</a> &nbsp; 
    <a href="logout.jsp">Local logout</a> &nbsp; <a href="<%= request.getRequestURL() %>?<%= Constants.QUERY_STRING_FORCE_AUTHN %>=True">Force login</a>
    <a href="call_service.jsp">
      Call Service
    </a>
    <br />
